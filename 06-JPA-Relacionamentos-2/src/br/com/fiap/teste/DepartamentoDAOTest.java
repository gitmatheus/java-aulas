...
class DepartamentoDAOTest {
	...
	//Método que executa entes de todos os testes
	@BeforeAll
	...
	public void cadastrarAntesDosTeste() {
		...
		try {
			...
			Funcionario f1 = new Funcionario("João", Calendar.getInstance(),1000);
			Funcionario f2 = new Funcionario("Maria", Calendar.getInstance(),2000);
